        ...
        if (darkMode) {
            ...
            map.values().stream().forEach(campoDato -> {
                Arrays.stream(campoDato.getComponentes())
                        ...
                        .forEach(c -> c.setBackground(ColorVariables.COLOR_BOTON_DARK));
                campoDato.getInfoLabel().setForeground(ColorVariables.COLOR_BOTON_TEXTO_DARK);
            });
            ...
            map.values().stream().forEach(campoDato -> {
                Arrays.stream(campoDato.getComponentes())
                        .filter(JTextField.class::isInstance)
                        .forEach(c -> c.setBackground(ColorVariables.COLOR_BOTON_LIGHT));
                campoDato.getInfoLabel().setForeground(ColorVariables.COLOR_BOTON_TEXTO_LIGHT);
            });
