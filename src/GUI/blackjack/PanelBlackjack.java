    ...
    protected void paintComponent(Graphics g) {
        ...
        try {
            ...
            for (int i = 0; i < this.manoCrupier.size(); i++) {
                Image imagenCarta = new ImageIcon(getClass().getResource(this.manoCrupier.get(i).getRutaImagen()))
                        .getImage();
            ...
            for (int i = 0; i < this.manoJugador.size(); i++) {
                Image imagenCarta = new ImageIcon(getClass().getResource(this.manoJugador.get(i).getRutaImagen()))
                        .getImage();
