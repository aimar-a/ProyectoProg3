...
public class PanelTablaDeApuestas extends JPanel {
    ...
    public PanelTablaDeApuestas(PanelRuleta ruleta, String usuario, boolean darkMode) {
        ...
        lblInfo.setForeground(darkMode ? ColorVariables.COLOR_TEXTO_DARK : ColorVariables.COLOR_TEXTO_LIGHT);
        add(lblInfo, gbc);
        ...
        for (int i = 4; i < 10; i++) {
            gbc.gridx = i;
            ImageIcon icon = new ImageIcon("src/img/ruleta/" + fichas[i - 4] + ".png");
            ...
            if (i - 4 == 0) {
                ...
                btn.setBackground(darkMode ? ColorVariables.COLOR_BOTON_DARK : ColorVariables.COLOR_BOTON_LIGHT);
            }
            final int index = i - 4;
    ...
    private void seleccionarFicha(int ficha) {
        ...
        for (int i = 0; i < 6; i++) {
            if (i == ficha) {
                ...
                botonesFichas[i].setBackground(
                        darkMode ? ColorVariables.COLOR_BOTON_DARK : ColorVariables.COLOR_BOTON_LIGHT);
            }
        }
    }
